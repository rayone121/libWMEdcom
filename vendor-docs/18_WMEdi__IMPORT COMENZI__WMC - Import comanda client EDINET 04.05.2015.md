# Import comandă client format.xml (structura EDINET)

<sub>Source: `18_WMEdi__IMPORT COMENZI__WMC - Import comanda client EDINET 04.05.2015.pdf` — WinMENTOR official documentation, converted from PDF.</sub>
Import comandă client format.xml (structura EDINET)
...
firmei (figura 1), iar codul atribuit de client va fi asociat prin intermediul programului
WMEdi, interfața opțiunii „Identificare (vezi figura 2).
