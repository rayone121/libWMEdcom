...
<sub>Source: `22_Structuri import din alte aplicatii__Structuri import din alte aplicatii - SAF-T__Articole noi.pdf` — WinMENTOR official documentation, converted from PDF.</sub>
Structura import articole noi [ARTICOLE.txt] în
                                              WinMENTOR
...
ExportSAFT=D
CodNCSAFT=                           • se completează cu CodNC              din
                                     Nomenclatorul SAF-T TARIC3
                                     Poate lua una din cele trei valori:
                                     1 – nu este solvent;
SolventSAFT=
                                     2 – solvent blue 35;
                                     3 – solvent yellow 124.
Serviciu=D
ContServiciu=768
GestiuneImplicita=
Clasa=
