...
<sub>Source: `22_Structuri import din alte aplicatii__Structuri import din alte aplicatii - SAF-T__Facturi de intrare.pdf` — WinMENTOR official documentation, converted from PDF.</sub>
...
| `Item_1_TVANEDED` | • Poate lua valorile 0, 1, 3 (deductibil 100% , nedeductibil |
| `•` | 100%, ½ neded) Asigură corespondența dintre |
| `[Factura_2]` |  |
...
| `TotalArticole=1` |  |
| `Discount=18.0000` |  |
| `ValoareSuplimentare=10` | • Total valoare „suplimentare”. Se repartizează pe fiecare articol |
| `ContSuplimentare=101.01` | în parte, la poziția respectivă. |
| `•` | TipRepartizare: |
